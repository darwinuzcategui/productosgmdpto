...
class RegistroPage extends StatelessWidget {
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text('Crear Cuenta Nueva', style: TextStyle(fontSize: 20.0)),
          ...
          FlatButton(
              ...
              child: Text('Ya tienes una Cuenta registrada ?')),
  ...
  _register(LoginBloc bloc, BuildContext context) async {
    ...
    */
    ...
    final info = await usuarioProvider.nuevoUsuario(bloc.email, bloc.clave);
